 ...
 *
 */
@TableName(value = "CALC_REL")
public class CalcRelPojo implements Serializable {
	...
	@TableField(exist = false)
	private String oldCalcRelCode;

	public CalcRelPojo(){

	}

	public CalcRelPojo(String calcRelCode){
	...
	public String getOldCalcRelCode() {
		return oldCalcRelCode;
	}

	public void setOldCalcRelCode(String oldCalcRelCode) {
		this.oldCalcRelCode = oldCalcRelCode;
	}
